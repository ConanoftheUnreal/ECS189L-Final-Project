...
namespace Polarith.AI.Package
{
    ...
    /// cref="WheelMeshes"/>.
    /// <para/>
    /// The <see cref="Move(float, float, float)"/> method acts as an interface between the vehicle physics and the user
    /// input which can be anything from AI to InputDevices.
    /// <para/>
    ...
    public class VehiclePhysics : MonoBehaviour
    {
        ...
        /// Expects a value in the range [0, 1]. It translates into the current torque that is applied to the <see
        /// cref="MotorWheels"/> where 0 is don't move and 1 is full possible torque.
        /// </param>
        /// <param name="brake">
